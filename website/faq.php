...
</style><title>TheFacebook | FAQ</title> 
...
<tr><td class='white' bgcolor=#3B5998>Common Questions</td></tr></table><center><p class='title'>[ FAQ ]</p><center><table cellspacing=0 cellpadding=0 border=0 width=95%><tr><td><center>

<table class='bordertable' cellspacing=0 cellpadding=0 width=90%><tr><td><table cellspacing=0 cellpadding=2 border=0 width=100%> 
<tr><td class='white' bgcolor=#3B5998>FAQs</td></tr></table>
&nbsp;<br><center> 
<table cellspacing=0 cellpadding=2 border=0 width=95%>
	<tr>
		<td>
			<b>Q. How many pending friend requests can I have?</b><br>
A. The limit is 10 pending requests at one time.<br><br>
<b>Q. How many relationships may I be in?</b><br>
A. Right now, the site is limited to 5 relationships. This does not include your friends.<br><br>
<b>Q. I can't adjust my network size higher than "My University" in my account privacy.</b><br>
A. As of right now, we are currently limiting the network size until we have obtained the critical mass needed to expand.<br><br>
<b>Q. If I deactivate my account, will users still be able to find my profile?</b><br>
A. No
		</td>
	</tr>
</table>
