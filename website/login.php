...
<tr><td class='white' bgcolor=#3B5998>Login</td></tr></table><center><p class='title'>[ Login ]</p><center>
...
?>
<div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#appId=216469101714486&amp;xfbml=1"></script><fb:login-button registration-url="http://fb.harvardconnection.co/register.php" show-faces="false" width="200" max-rows="5"></fb:login-button> 
<?PHP
}
?>
</center>
