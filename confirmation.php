...
if(strlen($_GET['id'])>5&&strlen($_GET['code'])>5){
	$auth = new Authenticate();

	$status= $auth->confirmation($_GET['id'], $_GET['code']);

}

	switch ($status) {
		case 1:
			$registersuccess = "<font size=3><center>You have successfully confirmed your account!<br><br>You may now login and start adding your friends</center></font>";
		break;
		default:
			$registersuccess = "<p class='red'><b>An error has occurred, please try again later</b></p>";
		break;
	}
...
</style><title>TheFacebook | Confirmation</title> 
...
<tr><td class='white' bgcolor=#3B5998>Confirmation</td></tr></table><center><table cellspacing=0 cellpadding=0 border=0 width=95%><tr><td> 
<center><table cellspacing=0 cellpadding=0 border=0 width=90%><tr><td> 

<p> 
<center> 
<?PHP
echo "<table style='width:100%;height:150px'><tr><td>$registersuccess</td></tr></table>"; // RETURN MESSAGE
?>
</center> 
</td></tr></table> 
